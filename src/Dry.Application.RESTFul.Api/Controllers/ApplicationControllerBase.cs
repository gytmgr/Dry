...
public abstract class ApplicationControllerBase<TService> : DryControllerBase
{
    /// <summary>
    /// 应用服务
    /// </summary>
...
public abstract class ApplicationControllerBase<TService, TResult> :
    ApplicationControllerBase<TService>,
...
public abstract class ApplicationControllerBase<TService, TResult, TKey> :
...
/// <typeparam name="TKey"></typeparam>
public abstract class ApplicationControllerBase<TService, TResult, TCreate, TEdit, TKey> :
    ApplicationCreateEditControllerBase<TService, TResult, TCreate, TEdit, TKey>,
