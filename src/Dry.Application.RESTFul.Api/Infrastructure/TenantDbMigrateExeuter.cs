...
public abstract class TenantDbMigrateExeuter<TBoundedContext> : IRequestResourceExecuter, ISingletonDependency<IRequestResourceExecuter> where TBoundedContext : IBoundedContext
{
