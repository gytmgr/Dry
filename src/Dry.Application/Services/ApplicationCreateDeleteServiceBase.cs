...
public abstract class ApplicationCreateDeleteServiceBase<TBoundedContext, TEntity, TResult, TCreate, TKey> :
    ...
    where TCreate : ICreateDto
{
    ...
    public ApplicationCreateDeleteServiceBase(IServiceProvider serviceProvider) : base(serviceProvider)
    { }
...
/// <typeparam name="TCreate"></typeparam>
/// <typeparam name="TKey"></typeparam>
public abstract class ApplicationQueryCreateDeleteServiceBase<TBoundedContext, TEntity, TResult, TQuery, TCreate, TKey> :
    ...
    where TCreate : ICreateDto
{
    ...
    /// </summary>
    /// <param name="serviceProvider"></param>
    public ApplicationQueryCreateDeleteServiceBase(IServiceProvider serviceProvider) : base(serviceProvider)
    { }
