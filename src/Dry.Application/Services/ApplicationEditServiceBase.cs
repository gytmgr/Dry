...
public abstract class ApplicationEditServiceBase<TBoundedContext, TEntity, TResult, TEdit, TKey> :
    ...
    where TEdit : IEditDto
{
    ...
    public ApplicationEditServiceBase(IServiceProvider serviceProvider) : base(serviceProvider) { }
...
/// <typeparam name="TEdit"></typeparam>
/// <typeparam name="TKey"></typeparam>
public abstract class ApplicationQueryEditServiceBase<TBoundedContext, TEntity, TResult, TQuery, TEdit, TKey> :
    ...
    where TEdit : IEditDto
{
    ...
    /// </summary>
    /// <param name="serviceProvider"></param>
    public ApplicationQueryEditServiceBase(IServiceProvider serviceProvider) : base(serviceProvider) { }
