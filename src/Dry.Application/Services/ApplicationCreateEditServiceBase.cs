...
public abstract class ApplicationCreateEditServiceBase<TBoundedContext, TEntity, TResult, TCreate, TEdit, TKey> :
    ApplicationCreateServiceBase<TBoundedContext, TEntity, TResult, TCreate, TKey>,
    ...
    where TEdit : IEditDto
{
    ...
    public ApplicationCreateEditServiceBase(IServiceProvider serviceProvider) : base(serviceProvider)
    { }
...
/// <typeparam name="TEdit"></typeparam>
/// <typeparam name="TKey"></typeparam>
public abstract class ApplicationQueryCreateEditServiceBase<TBoundedContext, TEntity, TResult, TQuery, TCreate, TEdit, TKey> :
    ApplicationQueryCreateServiceBase<TBoundedContext, TEntity, TResult, TQuery, TCreate, TKey>,
    ...
    where TEdit : IEditDto
{
    ...
    /// </summary>
    /// <param name="serviceProvider"></param>
    public ApplicationQueryCreateEditServiceBase(IServiceProvider serviceProvider) : base(serviceProvider)
    { }
