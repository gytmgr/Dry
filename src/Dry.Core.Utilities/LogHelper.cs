...
public static class LogHelper
{
    ...
    {
        className.CheckParamNull(nameof(className));
        methodName.CheckParamNull(nameof(methodName));
        e.CheckParamNull(nameof(e));
    ...
    {
        relativePath.CheckParamNull(nameof(relativePath));
