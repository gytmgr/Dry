...
public abstract class DbContextFactoryBase<TBoundedContext> : IDesignTimeDbContextFactory<DryDbContext<TBoundedContext>> where TBoundedContext : IBoundedContext
{
    /// <summary>
    /// 注入程序集命名前缀
    /// </summary>
