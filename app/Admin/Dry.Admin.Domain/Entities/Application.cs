...
/// 应用
/// </summary>
public class Application : EntityBase, IAggregateRoot<string>, IAdminContext, IHasName, IHasAddTime, IHasUpdateTime, ICreate
{
    /// <summary>
    /// 系统id
    /// </summary>
    ...
    public virtual async Task CreateAsync([NotNull] IServiceProvider serviceProvider)
    {
        ...
        AddEvent(new ApplicationAddEvent { Application = this });
    }
}